...
% teraz do zaimplementowania jest sama funkcja licz¹ca pdf (liczenie gestosci)
...
% poniewa¿ wartoci minimalne czy maksymalne da siê wyznaczyæ zawsze,
...
% procedurê szukania i usuwania wartoci odstaj¹cych trzeba powtarzaæ do skutku

% po usuniêciu wartoci odstaj¹cych mo¿na zaj¹æ siê wyborem DWÓCH cech dla klasyfikacji
% w tym przypadku w zupe³noci wystarczy poogl¹daæ wykresy dwóch cech i wybraæ te, które
...
% (po prawdzie, to dla funkcji licz¹cej gêstoæ prawdobieñstwa) z za³o¿eniem,
% ¿e cechy s¹ niezale¿ne

pdfindep_para = para_indep(train);
pdfmulti_para = para_multi(train);
pdfparzen_para = para_parzen(train, 0.001); 
% w sprawozdaniu trzeba podawaæ szerokoæ okna (nie liczymy tego parametru z danych!)	
...
% W sprawozdaniu proszê podaæ tylko wartoæ redni¹ i odchylenie standardowe wspó³czynnika b³êdu
